...
@UNGAPPED_SCORE_ALGORITHM.register('sum_proba_score_correct0')
...
def ungapped_extension(query, matches_dict, reference_matrix_file, k, delta,
    ...
    for match in matches_dict:
        ...
        while (diff_right > -delta) and (current_pos_right_ref < ref_length - 1) and (
            ...
            current_score_right += UNGAPPED_SCORE_ALGORITHM[score_method](probas_ref, letter_query, mismatch_score,
                                                                          substitution)
